        ...
        projectsWithCoords.forEach(project => {
          ...
          const popupContent = `
            <div style="min-width: 200px;">
              ...
              <p style="margin: 0 0 4px 0; font-size: 12px; color: #666;">${project.location}</p>
          ...
          if (isSelected) {
            marker.openPopup();
            mapInstanceRef.current.setView([project.latitude, project.longitude], 14);
          }
    ...
    return (
      <div className="flex h-96 items-center justify-center rounded-lg border border-neutral-200 bg-neutral-50">
        <div className="text-center">
          <MapPin className="mx-auto mb-4 h-12 w-12 text-neutral-400" strokeWidth={1.5} />
  ...
  return (
    <div className="relative">
      {onClose && (
        <button
          onClick={onClose}
          className="absolute right-4 top-4 z-[1000] bg-white p-2 shadow-lg transition-colors hover:bg-neutral-100"
