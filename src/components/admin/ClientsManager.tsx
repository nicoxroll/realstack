import { Edit2, Mail, Phone, Plus, Save, Trash2, X } from "lucide-react";
    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 border border-green-500 px-3 md:px-4 py-2 text-sm tracking-wider text-green-600 transition-all hover:bg-green-50"
          title={showCreateForm ? "Cancelar" : "Nuevo cliente"}
        >
          {showCreateForm ? (
        ...
        <div className="mb-6 border border-neutral-200 bg-neutral-50 p-6">
          ...
          >
            ...
            <div className="flex gap-2">
              <button
                type="submit"
                className="flex items-center gap-2 border border-green-500 px-4 md:px-6 py-3 text-sm tracking-wider text-green-600 transition-all hover:bg-green-50"
              >
      ...
      <div className="space-y-4">
        ...
        {clients.length === 0 && (
          <div className="border border-neutral-200 bg-white p-12 text-center">
            <p className="text-sm font-light text-neutral-500">
              No hay clientes registrados aún. Haz clic en "NUEVO CLIENTE" para
              agregar uno.
            </p>
          </div>
        )}
