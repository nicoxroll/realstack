...
import { supabase, PageConfig } from '../../lib/supabase';
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="mt-1 text-xs font-light text-neutral-500">
            Para obtener la URL: Ve a Google Maps, busca la ubicación, haz clic en
            "Compartir" {">"} "Insertar un mapa" y copia la URL del iframe
          </p>
        </div>
